...
require_once dirname(__FILE__).'/MajaxEnewsletter/Interface.php';

class MajaxEnewsletter implements MajaxEnewsletter_Interface {
  /**
   * @var string
   */
  private $from_email;
  ...
  {
    spl_autoload_register(array('MajaxEnewsletter', 'doAutoload'));
  }
