...
class unit_majaxEnewsletterFormatterTest extends sfPHPUnitBaseTestCase
{
  /**
   * @var majaxEnewsletterFormatter
   */
  private $formatter;

  public function setUp()
  {
    $this->formatter = new majaxEnewsletterFormatter();
  }
  ...
  public function test_FormatterAcceptsCodesFromConstructor()
  {
    ...
    $formatter = new majaxEnewsletterFormatter($codes);
